...
![ChromaDB](https://img.shields.io/badge/ChromaDB%20(Vector%20DB)-FF6F00?style=flat-square)
...
### 🦺 [산업 안전 챗봇](https://github.com/Focus-Report/Rag_chatbot) (팀 프로젝트)
 
건설공사 산업안전보건 규정 기반 RAG 챗봇. LLM 응답의 사실 검증 레이어를 설계했습니다.
